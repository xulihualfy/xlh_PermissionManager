...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-menu-add">
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input value="用户管理" type="text"  class="input-text" value=""
    ...
    <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" name="menuUrl"
                       value="user/delete" class="input-text">
            </div>
            <div class="col-4"> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text"
                       autocomplete="off" value="user:delete"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="用户权限"
                        name="menuDesc"
                       id="menuDesc">
            </div>
            <div class="col-4"> </div>
