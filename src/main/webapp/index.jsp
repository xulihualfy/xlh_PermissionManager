...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        <shiro:hasPermission name="user:getUserPage">
        <dl id="menu-article">
            <dt><i class="Hui-iconfont">&#xe616;</i> 用户管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a _href="user/getPage" href="javascript:void(0)">用户管理</a></li>
                </ul>
            </dd>
        ...
        <dl id="menu-admin">
            <shiro:authenticated><!-- 表示已经通过登录认证-->
            `<dt><i class="Hui-iconfont">&#xe62d;</i> 管理员管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
                </dt></shiro:authenticated>
            <dd>
                <ul>
                    <shiro:hasPermission name="role:getRolePage">
                        <li><a _href="role/getRolePge" href="javascript:void(0)">角色管理</a></li>
                    </shiro:hasPermission>

                    <shiro:hasPermission name="menu:getMenuPage">
                        <li><a _href="menu/getPage" href="javascript:void(0)">权限管理</a></li>
                    </shiro:hasPermission>

                    <shiro:hasRole  name="系统管理员">
                    <li><a _href="auth/getRoleList" href="javascript:void(0)">授权管理</a></li>
                    </shiro:hasRole>
                </ul>
            </dd>
        </dl>
